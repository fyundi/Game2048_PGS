...
export declare class Base {
    ...
    protected CheckIsKickOff(client: Client, ackMessage: ServerAckMessage): void;
}
...
export declare class Client extends Base {
     ...
     * @param seqName
     */
    sendEpJoinRoomMessage(resp: CreateOrJoinRoomResponse, seqName: string): Promise<Room>;
    /**
     * 取消匹配
 ...
 * 创建或加入房间返回信息
 * @param roomInfo - 房间信息
 * @param ticket - 建立ws连接所需校验的凭证
 * @param netMode - 网络模式（默认是1） 1:WSS/EndPoint 2:RTSA/SFU
 */
declare interface CreateOrJoinRoomResponse extends BaseResponse {
    roomInfo: RoomInfo;
    ticket: string;
    netMode: number;
}
...
export declare enum ErrorCode {
    ...
    JOIN_OR_CREATE_GROUP_FAILED = 91002
}
...
export declare class Group extends Base {
    ...
    removeAllListeners(): void;
    private initWsMsgHandlers;
    protected onWsMessage(ev: MessageEvent): void;
    private matchStartMsgHandle;
...
export declare class Player extends Base {
    ...
    private wsMsgHandlerMap;
    constructor(client: Client, customStatus?: number, customProperties?: string);
    /**
     * 更新玩家自定义状态
     */
    ...
    protected onWsMessage(ev: MessageEvent): void;
    private onPlayerUpdatePropAckHandler;
    private onPlayerUpdateStatusHandler;
    private initWsMsgHandlers;
...
export declare class Room extends Base {
    ...
    onWsClose(ev: CloseEvent | string): Promise<void>;
    protected onWsMessage(ev: MessageEvent): void;
    private realtimeBroadcastHandle;
